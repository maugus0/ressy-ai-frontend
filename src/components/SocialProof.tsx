const SocialProof = () => {
  const testimonials = [
    {
      quote:
        "RessyAI handles 200+ calls daily with perfect accuracy. Our staff can focus on cooking instead of answering phones.",
    ...
    {
      quote:
        "We've seen a 40% increase in phone orders since implementing RessyAI. It never gets orders wrong.",
      author: "David Chen",
    ...
    {
      quote:
        "The setup was incredibly easy. Within 20 minutes we were taking AI-powered calls. Game changer!",
