      ...
      <div className="relative mx-auto max-w-6xl px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-5">
          {[...inner, ...outer].map((logo, idx) => {
            const emphasis = ["HubSpot", "Salesforce", "Zapier"].includes(
              logo.alt,
            );
            return (
              <div
                key={logo.alt}
                className={`group relative rounded-2xl border bg-white/80 backdrop-blur transition-all duration-300 shadow-[0_6px_24px_-12px_rgba(15,23,42,0.15)] hover:shadow-[0_10px_34px_-12px_rgba(15,23,42,0.22)] ${emphasis ? "border-slate-200 col-span-1 lg:col-span-2" : "border-slate-100"} animate-float`}
                style={{
              ...
              >
                <div className="flex items-center justify-center h-24 sm:h-28 lg:h-28 px-4 animate-fade-up">
                  <img
                    src={logo.src}
                    alt={logo.alt}
                    className="h-8 sm:h-9 lg:h-10 object-contain saturate-0 opacity-70 group-hover:saturate-100 group-hover:opacity-100 transition duration-300"
                    loading="lazy"
                  />
                </div>
                    ...
                    <div className="sm:col-span-1">
                      <dl className="text-sm">
                        ...
                        <div className="mt-5 sm:hidden flex items-center gap-2">
                          <a
                            href="#contact"
                            className="inline-flex items-center justify-center rounded-full bg-black text-white text-sm font-semibold px-4 py-2 hover:shadow-md hover:scale-[1.02] transition"
                          >
                            Connect
                          </a>
                          <a
                            ...
                            className="inline-flex items-center justify-center rounded-full border border-slate-300 text-slate-800 text-sm font-medium px-4 py-2 hover:bg-slate-50 transition"
                          >
                            Learn More
                          </a>
                        </div>
